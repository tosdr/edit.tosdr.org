...
ActiveRecord::Schema.define(version: 20_241_016_150_146) do
  ...
  create_table 'document_meta', id: :serial, force: :cascade do |t|
    ...
    t.integer 'document_id', null: false
    t.index %w[claimant_normalized type], name: 'uq__document_meta__claimant_normalized', unique: true
  ...
  create_table 'document_uri', id: :serial, force: :cascade do |t|
    ...
    t.integer 'document_id', null: false
    t.index %w[claimant_normalized uri_normalized type content_type],
            name: 'uq__document_uri__claimant_normalized', unique: true
  ...
  create_table 'featurecohort_feature', id: :serial, force: :cascade do |t|
    ...
    t.index %w[cohort_id feature_id], name: 'uq__featurecohort_feature__cohort_id', unique: true
  end

  create_table 'featurecohort_user', id: :serial, force: :cascade do |t|
    t.integer 'cohort_id', null: false
    t.integer 'user_id', null: false
    t.index %w[cohort_id user_id], name: 'uq__featurecohort_user__cohort_id', unique: true
  end
  ...
  create_table 'flag', id: :serial, force: :cascade do |t|
    ...
    t.uuid 'annotation_id', null: false
    t.integer 'user_id', null: false
    t.index %w[annotation_id user_id], name: 'uq__flag__annotation_id', unique: true
  ...
  create_table 'groupscope', id: :serial, force: :cascade do |t|
    ...
    t.text 'path'
    t.index %w[origin path], name: 'ix__groupscope__scope'
  end
  ...
  create_table 'spams', force: :cascade do |t|
    ...
    t.index %w[spammable_type spammable_id], name: 'index_spams_on_spammable_type_and_spammable_id'
  end
  ...
  create_table 'user', id: :serial, force: :cascade do |t|
    ...
    t.index %w[email authority], name: 'uq__user__email', unique: true
  ...
  create_table 'user_group', id: :serial, force: :cascade do |t|
    t.integer 'user_id', null: false
    t.integer 'group_id', null: false
    t.index %w[user_id group_id], name: 'uq__user_group__user_id', unique: true
  end
  ...
  create_table 'user_identity', id: :serial, force: :cascade do |t|
    ...
    t.integer 'user_id', null: false
    t.index %w[provider provider_unique_id], name: 'uq__user_identity__provider', unique: true
  end
  ...
  add_foreign_key 'annotation_moderation', 'annotation', name: 'fk__annotation_moderation__annotation_id__annotation',
                                                         on_delete: :cascade
  add_foreign_key 'authticket', '"user"', column: 'user_id', name: 'fk__authticket__user_id__user',
                                          on_delete: :cascade
  ...
  add_foreign_key 'featurecohort_feature', 'feature', name: 'fk__featurecohort_feature__feature_id__feature',
                                                      on_delete: :cascade
  add_foreign_key 'featurecohort_feature', 'featurecohort', column: 'cohort_id',
                                                            name: 'fk__featurecohort_feature__cohort_id__featurecohort'
  add_foreign_key 'featurecohort_user', '"user"', column: 'user_id', name: 'fk__featurecohort_user__user_id__user'
  add_foreign_key 'featurecohort_user', 'featurecohort', column: 'cohort_id',
                                                         name: 'fk__featurecohort_user__cohort_id__featurecohort'
  ...
  add_foreign_key 'groupscope', '"group"', column: 'group_id', name: 'fk__groupscope__group_id__group',
                                           on_delete: :cascade
  ...
  add_foreign_key 'user_identity', '"user"', column: 'user_id', name: 'fk__user_identity__user_id__user',
                                             on_delete: :cascade
end
